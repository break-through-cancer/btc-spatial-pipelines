...
required <- c("Seurat", "ggplot2", "leiden", "patchwork", "dplyr", "rhdf5",
              "ggrepel", "Rfast2", "EnhancedVolcano", "fgsea", "msigdbr",
              "RColorBrewer", "ggpubr")
...
save(BTC13epit, file = paste(output_dir,"BTC13epit_modscores.Rda", sep="/"))
```
